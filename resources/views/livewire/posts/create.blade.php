            ...
            <div class="modal-content p-3 p-md-5">
                <div class="modal-body">
                    ...
                    <form class="row g-3" wire:submite.prevent="save" enctype="multipart/form-data">
                        ...
                        <div class="col-md-7">
                            <div class="row">
                                <div class="col-md-12 select-posts">
                                    <label class="form-label" for="place_id">{{__('Place')}}</label>
                                    <select id="place_id" name="place_id" wire:model.defer="place_id" class="select2 form-select single-select" data-placeholder="{{__('Select a place')}}...">
                                        <option></option>
