            ...
            <div class="modal-content p-3 p-md-5">
                <div class="modal-body">
                    ...
                    <div class="text-center mb-4">
                        <h3 class="mb-2">{{__('Add category')}}</h3>
                        <p class="text-muted">{{__('Complete the information to add a new category')}}</p>
                    </div>
                    <form class="row g-3" wire:submite.prevent="save">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" id="priority" class="form-control" placeholder="" name="priority" aria-label="" wire:model.defer="priority" />
                            @error('priority')
                            <div class="badge bg-label-danger mt-2 w-100">{{ __($message) }}</div>
                            @enderror
                        </div>
