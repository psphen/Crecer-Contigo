<div wire:init="readyToLoad">
    <div wire:ignore.self class="card" id="show">
        <div class="card-header">
            <div class="row">
                <div class="col-md-4">
                    <h5 class="card-title mb-3">{{__('Cities')}}</h5>
                </div>
                <div class="col-md-8">
                        ...
                        <div id="DataTables_Table_0_filter" class="dataTables_filter">
                            ...
                            <label for="">
                                <select wire:model="is_active" id="is_active" class="form-select mx-0">
                                    <option value="1" @if($is_active) selected @endif>{{__('Active')}}</option>
        ...
        <div class="card-datatable table-responsive">
            <div id="DataTables_Table_0_wrapper" class="dataTables_wrapper dt-bootstrap5 no-footer">
                ...
                <table class="table">
                    ...
                    @empty
                        <tr class="odd">
                            <td valign="top" colspan="12" class="dataTables_empty text-center">{{$readyToLoad?__('No cities registered'):__('Loading').'...'}}</td>
                        </tr>
                    @endforelse
                    </tbody>
                </table>
                        ...
                        <div class="row mx-2 my-3">
                            <div class="col-md-5">
                                <div class="dataTables_info" id="DataTables_Table_0_info" role="status" aria-live="polite">
                                    {{__('Showing')}} {{ $cities->firstItem() }} {{__('to')}} {{ $cities->lastItem() }} {{__('of')}} {{ $cities->total() }} {{__('results')}}
                                </div>
                            </div>
